...
/*******************************************/
{
    ...
    if ( inFile.ios::fail() ) {
        //printf( "Directory::Directory() read\n" );
...
#ifdef _DEBUG
    printf( "Directory::Directory: dirPos=%X qsort( cnt=%X, size=%u )\n", directoryPos, _cvDirHeader.cDir, sizeof(cv_directory_entry) );
#endif
    if ( inFile.ios::fail() ) {
        //printf( "Directory::Directory qsort( cnt=%X, size=%u )\n", _cvDirHeader.cDir, sizeof(cv_directory_entry) );
        throw DebugInfoError();
    }
}
...
/*******************************/
{
    ...
    if ( _inputFile.ios::fail() ) {
        //printf( "Retriever::GetBasePos seekg\n" );
        throw DebugInfoError();
    }
...
/******************************/
{
    ...
    if ( ! SeekRead(&addr, _lfaBase - LONG_WORD, LONG_WORD) ) {
        //printf( "Retriever::GetPEDebugDirCVEntryPos SeekRead\n" );
        throw DebugInfoError();
    }
...
/******************************/
{
    ...
    if ( ! SeekRead(&lfoDir, _lfaBase + LONG_WORD, LONG_WORD) ) {
        //printf( "Retriever::GetDirPos SeekRead\n" );
        throw DebugInfoError();
    }
...
/**************************************************/
{
    ...
    if ( _inputFile.ios::rdstate() == ios::failbit ) {
        ...
        //printf( "Retriever::SeekRead rdstate\n" );
        throw DebugInfoError();
    }
