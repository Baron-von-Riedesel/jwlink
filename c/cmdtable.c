...
parse_entry     MainOptions[] = {
    ...
    "FUZzyexport",  &ProcFuzzyExport,   MK_PE, 0,
...
//  "PACKExp",      &ProcPackExp,       MK_PHAR_FLAT, 0,
    ...
    "VERSion",      &ProcVersion,       MK_NOVELL|MK_OS2_FLAT|MK_PE|MK_WIN_NE, 0,
...
parse_entry    Models[] = {
    ...
    "WINdows",      &ProcWindows,       MK_WIN_NE|MK_PE|MK_WIN_VXD, 0,  /* JWlink */
#endif
#ifdef _PHARLAP
...
parse_entry Exp_Keywords[] = {
    ...
    /* jwlink */
    "NONAME",       &ProcNoName,        MK_OS2|MK_PE, 0,
    NULL
};
...
parse_entry SegModel[] = {
    ...
    "READOnly",     &ProcReadOnly,      MK_OS2|MK_PE, 0,    /* jwlink: added MK_PE */
    "READWrite",    &ProcReadWrite,     MK_OS2, 0,
    "WRITAble",     &ProcWritable,      MK_PE, 0,     /* jwlink */
    "EXECUTAble",   &ProcExecutable,    MK_PE, 0,     /* jwlink */
